        ...
        try:
            ...
            if from_recv:
                ...
                if(sign == 11):
                    ...
                    os.system("cat data.txt | python mapper.py | sort -k1,1 > mapout2.txt")

                    print "map完毕，开始回传结果"
                    # 向控制节点发送map
                    sendfile("mapout2.txt", 1, Master)
                    ...
                    os.system("cat %s | python reducer.py > reduceout2.txt" % filename)

                    print "reduce完毕，开始回传结果"
                    sendfile("reduceout2.txt", 2, Master)
