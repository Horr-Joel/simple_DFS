        ...
        try:
            ...
            if from_recv:
                ...
                if(sign == 11):
                    ...
                    os.system("cat data.txt | python mapper.py | sort -k1,1 > mapout1.txt")

                    print "map完毕，开始回传结果"
                    # 向控制节点发送map
                    sendfile("mapout1.txt", 1, Master)
                    print "回传完毕"
                    ...
                    os.system("cat %s | python reducer.py > reduceout1.txt" % filename)
                    print "reduce完毕，开始回传结果"
                    sendfile("reduceout1.txt", 2, Master)
